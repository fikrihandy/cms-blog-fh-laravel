<x-layout :title="$title">
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:px-6">
        ...
        <form class="mb-8 max-w-md mx-auto">
            ...
            <div class="relative">
                ...
                <input type="search" id="default-search"
                    ...
                    placeholder="Search post title..." autocomplete="off" name="search" autofocus />
                <button type="submit"
        ...
        <div class="mt-4 grid gap-8 lg:grid-cols-3 md:grid-cols-2">
            ...
            @empty
                <div>
                    <p class="font-semibold text-xl my-4">Not found!</p>
                    <a href="/posts" class="block text-blue-500 hover:under">&laquo; Back to all posts.</a>
                </div>
            @endforelse
        </div>
    </div>
